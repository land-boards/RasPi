...
I2C-RPT-Intr-4x8.py - I2C-RPT-Intr-4x8 example code 

========
SYNOPSIS
========

sudo python I2C-RPT-Intr-4x8.py

===========
DESCRIPTION
===========

Used to demonstrate the operation of the I2C-RPT-Intr-4x8 card.
