...
* This macro is silicon dependent as PSoC 5LP devices have no CPU clock divider
...
/*******************************************************************************
* The low power mode entry is different for PSoC 3 and PSoC 5LP devices. The low
* power modes in PSoC 5LP devices are invoked by Wait-For-Interrupt (WFI)
