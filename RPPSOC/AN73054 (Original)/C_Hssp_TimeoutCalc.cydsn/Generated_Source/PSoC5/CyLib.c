...
void CyDelay(uint32 milliseconds) CYREENTRANT
{
    ...
    *  When the instruction cache is disabled on PSoC 5LP, CyDelayUs will be two times
...
*
*  lpMode: Low power mode configuration. This parameter is ignored for PSoC 5LP.
